...
namespace VietLacSo2022
{
    public partial class BanQuyen_2 : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void BanQuyen_2_Load(object sender, EventArgs e)
        {
            ...
            if (labelControl1.Text.Length > 40)
            {
                string label1 = labelControl1.Text.Substring(0, 40);
                string label2 = labelControl1.Text.Substring(40, labelControl1.Text.Length - label1.Length);
