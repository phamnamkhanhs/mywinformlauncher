    ...
    public partial class TaiKhoanCaNhan : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void TaiKhoanCaNhan_Load(object sender, EventArgs e)
        {
           ...
           // Form1 f = new Form1();
            ...
            if (accept == true)
            {
                ...
                if (r["gioitinh"].ToString()== checkEdit1.Text|| System.Globalization.CultureInfo.CurrentCulture.TextInfo.ToTitleCase(r["gioitinh"].ToString().ToLower())== checkEdit1.Text)
                {
                    checkEdit1.CheckState = CheckState.Checked;
                    checkEdit1.Checked = true;

                }
                if(r["gioitinh"].ToString() == checkEdit2.Text || System.Globalization.CultureInfo.CurrentCulture.TextInfo.ToTitleCase(r["gioitinh"].ToString().ToLower()) == checkEdit2.Text)
                {
        ...
        void myButton_Click(object sender, EventArgs e)
        {
            ...
            if (checkEdit1.Checked == true)
            {
                ...
                cmd.Parameters.AddWithValue("@gioitinh", checkEdit1.Text);
            ...
            else if (checkEdit2.Checked == true)
            {
                ...
                cmd.Parameters.AddWithValue("@sodienthoai", thetext4);
                cmd.Parameters.AddWithValue("@email", thetext5);
                cmd.Parameters.AddWithValue("@gioitinh", checkEdit2.Text);
                cmd.Parameters.AddWithValue("@diachi", thetext6);
                cmd.Parameters.AddWithValue("@matkhau", thetext7);
                cmd.Parameters.AddWithValue("@id", labelControl13.Text);
                SqlDataReader r = cmd.ExecuteReader();
